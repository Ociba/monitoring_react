...
class PersonalComplaints extends Component {
    ...
    fetchComplaints = () => {
        ...
        fetch(BASE_URL+'/api/v1/complaints/public/', {
            method: 'GET',
            headers: {
            ...
            <div id='main-wrapper'>
                ...
                <div className="page-wrapper" style={{ marginBottom: '50px' }}>
                    <div className="container-fluid" style={{ marginTop: '80px' }}>
                        <Breadcrumb pageName="Public Complaints" breadcrumbs={['Home', 'Public Complaints']}/>
                            ...
                            <table className='table table-striped'>
                                ...
                                <tbody>
                                    {filteredComplaints.map((complaint, index) => (
                                        <tr key={complaint.id}>
                                            <td>{index+1}</td>
                                            <td>{complaint.complainers_name}</td>
